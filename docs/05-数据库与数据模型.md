...
| `project_type` | VARCHAR(64) NULL | 项目类型，如 `non_illuminated_logo` / `illuminated_logo` / `lightbox` / `side_mounted_logo` |
...
```json
{
  "applicationType": "non_illuminated_logo",
  "dimensions": {
    "widthMm": 1200,
    "heightMm": 400,
    "depthMm": 80
